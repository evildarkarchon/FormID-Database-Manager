    ...
    public class StressTests : IDisposable
    {
        ...
        public async Task StressTest_RapidCancellations()
        {
            ...
            for (int i = 0; i < cancellationAttempts; i++)
            {
                ...
                // Start processing
                var processTask = pluginProcessingService.ProcessPlugins(parameters, null);
        ...
        public async Task StressTest_RapidUIUpdates()
        {
            ...
            for (int t = 0; t < threadCount; t++)
            {
                ...
                tasks.Add(Task.Run(() =>
                {
                    for (int i = 0; i < updateCount / threadCount; i++)
                    {
                        try
                        {
                            ...
                            if (i % 50 == 0)
                            {
                                ...
                                {
                                    Name = $"Plugin_T{threadId}_{i}.esp"
                                });
                            }
        ...
        public async Task StressTest_LargeDatabaseFile()
        {
            ...
            var pluginParam = command.Parameters.Add("@plugin", System.Data.DbType.String);
            var formidParam = command.Parameters.Add("@formid", System.Data.DbType.String);
            var entryParam = command.Parameters.Add("@entry", System.Data.DbType.String);
