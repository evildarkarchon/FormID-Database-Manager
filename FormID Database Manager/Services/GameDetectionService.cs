...
public class GameDetectionService
{
    ...
    {
        "Starfield.esm", "BlueprintShips-Starfield.esm", "OldMars.esm", "Constellation.esm"
    };
    ...
    /// <returns>
    ///     A <see cref="HashSet{T}" /> containing the base game plugin filenames for the specified game release.
    ///     Returns an empty set if the game release is unsupported.
    /// </returns>
    public virtual HashSet<string> GetBaseGamePlugins(GameRelease gameRelease)
    {
