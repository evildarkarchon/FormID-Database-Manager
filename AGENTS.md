...
For issue, PRD, or triage work, follow `docs/agents/issue-tracker.md` and `docs/agents/triage-labels.md`. Local Markdown
files under `.scratch/<feature>/` are the request surface; external pull requests are not.
